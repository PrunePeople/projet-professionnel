...
import { FaUserEdit, FaKey, FaSignOutAlt, FaChevronRight, FaInfoCircle, FaEye, FaEyeSlash, FaTools } from 'react-icons/fa';
...
const AdminDashboard = () => {
  ...
  const handleAdminPanelClick = () => {
    window.location.href = 'http://localhost:3001/adminJS'; // URL externe
};
    ...
    <div className="min-h-screen p-4 flex flex-col items-center mt-24">
      ...
      <div className="shadow-lg rounded-lg w-full max-w-2xl p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <MenuItem
            icon={<FaTools />}
            text="Mon panneau administrateur"
            isSecondary
